...
{
    public class ListRecommendationsByNextTokenResult : AbstractMwsObject
    {
        ...
        {
            writer.Write("https://mws.amazonservices.com/Recommendations/2013-04-01", "ListRecommendationsByNextTokenResult", this);
        }

        public ListRecommendationsByNextTokenResult() : base()
        {
        }
    }
}
