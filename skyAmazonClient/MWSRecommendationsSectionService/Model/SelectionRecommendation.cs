...
{
    public class SelectionRecommendation : AbstractMwsObject
    {
        ...
        public SelectionRecommendation WithLastUpdated(DateTime lastUpdated)
        {
        ...
        /// <returns>this instance.</returns>
        public SelectionRecommendation WithSalesRank(decimal salesRank)
        {
        ...
        /// <returns>this instance.</returns>
        public SelectionRecommendation WithNumberOfOffers(decimal numberOfOffers)
        {
        ...
        /// <returns>this instance.</returns>
        public SelectionRecommendation WithAverageCustomerReview(decimal averageCustomerReview)
        {
        ...
        /// <returns>this instance.</returns>
        public SelectionRecommendation WithNumberOfCustomerReviews(decimal numberOfCustomerReviews)
        {
        ...
        {
            writer.Write("https://mws.amazonservices.com/Recommendations/2013-04-01", "SelectionRecommendation", this);
        }

        public SelectionRecommendation() : base()
        {
        }
    }
}
