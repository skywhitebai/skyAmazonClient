...
namespace MWSRecommendationsSectionService.Model
{
    public class FulfillmentRecommendation : AbstractMwsObject
    {
        ...
        public FulfillmentRecommendation WithLastUpdated(DateTime lastUpdated)
        {
        ...
        /// <returns>this instance.</returns>
        public FulfillmentRecommendation WithSalesRank(decimal salesRank)
        {
        ...
        /// <returns>this instance.</returns>
        public FulfillmentRecommendation WithNumberOfOffers(decimal numberOfOffers)
        {
        ...
        /// <returns>this instance.</returns>
        public FulfillmentRecommendation WithNumberOfOffersFulfilledByAmazon(decimal numberOfOffersFulfilledByAmazon)
        {
        ...
        /// <returns>this instance.</returns>
        public FulfillmentRecommendation WithAverageCustomerReview(decimal averageCustomerReview)
        {
        ...
        /// <returns>this instance.</returns>
        public FulfillmentRecommendation WithNumberOfCustomerReviews(decimal numberOfCustomerReviews)
        {
        ...
        {
            writer.Write("https://mws.amazonservices.com/Recommendations/2013-04-01", "FulfillmentRecommendation", this);
        }

        public FulfillmentRecommendation() : base()
        {
        }
    }
}
