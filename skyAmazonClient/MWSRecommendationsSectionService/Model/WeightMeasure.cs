...
{
    public class WeightMeasure : AbstractMwsObject
    {
        ...
        public WeightMeasure WithValue(decimal value)
        {
            this._value = value;
            return this;
        }
        ...
        {
            writer.Write("https://mws.amazonservices.com/Recommendations/2013-04-01", "WeightMeasure", this);
        }

        public WeightMeasure() : base()
        {
        }
    }
}
