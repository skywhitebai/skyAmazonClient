...
{
    public class ListRecommendationsByNextTokenRequest : AbstractMwsObject
    {
        ...
        {
            writer.Write("https://mws.amazonservices.com/Recommendations/2013-04-01", "ListRecommendationsByNextTokenRequest", this);
        }

        public ListRecommendationsByNextTokenRequest() : base()
        {
        }
    }
}
