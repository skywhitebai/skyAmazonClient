...
namespace MWSRecommendationsSectionService
{
    ...
    public class MWSRecommendationsSectionServiceConfig {
        ...
        private const string DEFAULT_SERVICE_PATH = "Recommendations/2013-04-01";
        private const string SERVICE_VERSION = "2013-04-01";
        ...
        /// <returns>this instance</returns>
        public MWSRecommendationsSectionServiceConfig WithUserAgent(String userAgent)
        {
        ...
        /// May include the path to make MWS calls to. Defaults to Recommendations/2013-04-01
        /// </summary>
        ...
        /// <returns>this instance</returns>
        public MWSRecommendationsSectionServiceConfig WithServiceURL(string serviceURL)
        {
