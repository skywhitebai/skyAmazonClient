...
namespace FBAInventoryServiceMWS.Model
{
    ...
    public class InventorySupplyDetail : AbstractMwsObject
    {
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "SupplyType")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "EarliestAvailableToPick")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "LatestAvailableToPick")]
