...
namespace FBAInventoryServiceMWS.Mock
{
    ...
    /// </remarks>
    public class FBAInventoryServiceMWSMock : FBAInventoryServiceMWS
    {
        ...
        {
            return newResponse<ListInventorySupplyByNextTokenResponse>();
        }
