...
namespace MWSFinancesService.Model
{
    public class FinancialEvents : AbstractMwsObject
    {
        ...
        private List<NetworkComminglingTransactionEvent> _networkComminglingTransactionEventList;
        private List<AffordabilityExpenseEvent> _affordabilityExpenseEventList;
        private List<AffordabilityExpenseEvent> _affordabilityExpenseReversalEventList;
        ...
        /// <summary>
        /// Gets and sets the NetworkComminglingTransactionEventList property.
        /// </summary>
        public List<NetworkComminglingTransactionEvent> NetworkComminglingTransactionEventList
        {
            get
            {
                if(this._networkComminglingTransactionEventList == null)
                {
                    this._networkComminglingTransactionEventList = new List<NetworkComminglingTransactionEvent>();
                }
                return this._networkComminglingTransactionEventList;
            }
            set { this._networkComminglingTransactionEventList = value; }
        }

        /// <summary>
        /// Sets the NetworkComminglingTransactionEventList property.
        /// </summary>
        /// <param name="networkComminglingTransactionEventList">NetworkComminglingTransactionEventList property.</param>
        /// <returns>this instance.</returns>
        public FinancialEvents WithNetworkComminglingTransactionEventList(NetworkComminglingTransactionEvent[] networkComminglingTransactionEventList)
        {
            this._networkComminglingTransactionEventList.AddRange(networkComminglingTransactionEventList);
            return this;
        }

        /// <summary>
        /// Checks if NetworkComminglingTransactionEventList property is set.
        /// </summary>
        /// <returns>true if NetworkComminglingTransactionEventList property is set.</returns>
        public bool IsSetNetworkComminglingTransactionEventList()
        {
            return this.NetworkComminglingTransactionEventList.Count > 0;
        }

        /// <summary>
        /// Gets and sets the AffordabilityExpenseEventList property.
        /// </summary>
        public List<AffordabilityExpenseEvent> AffordabilityExpenseEventList
        {
            get
            {
                if(this._affordabilityExpenseEventList == null)
                {
                    this._affordabilityExpenseEventList = new List<AffordabilityExpenseEvent>();
                }
                return this._affordabilityExpenseEventList;
            }
            set { this._affordabilityExpenseEventList = value; }
        }

        /// <summary>
        /// Sets the AffordabilityExpenseEventList property.
        /// </summary>
        /// <param name="affordabilityExpenseEventList">AffordabilityExpenseEventList property.</param>
        /// <returns>this instance.</returns>
        public FinancialEvents WithAffordabilityExpenseEventList(AffordabilityExpenseEvent[] affordabilityExpenseEventList)
        {
            this._affordabilityExpenseEventList.AddRange(affordabilityExpenseEventList);
            return this;
        }

        /// <summary>
        /// Checks if AffordabilityExpenseEventList property is set.
        /// </summary>
        /// <returns>true if AffordabilityExpenseEventList property is set.</returns>
        public bool IsSetAffordabilityExpenseEventList()
        {
            return this.AffordabilityExpenseEventList.Count > 0;
        }

        /// <summary>
        /// Gets and sets the AffordabilityExpenseReversalEventList property.
        /// </summary>
        public List<AffordabilityExpenseEvent> AffordabilityExpenseReversalEventList
        {
            get
            {
                if(this._affordabilityExpenseReversalEventList == null)
                {
                    this._affordabilityExpenseReversalEventList = new List<AffordabilityExpenseEvent>();
                }
                return this._affordabilityExpenseReversalEventList;
            }
            set { this._affordabilityExpenseReversalEventList = value; }
        }

        /// <summary>
        /// Sets the AffordabilityExpenseReversalEventList property.
        /// </summary>
        /// <param name="affordabilityExpenseReversalEventList">AffordabilityExpenseReversalEventList property.</param>
        /// <returns>this instance.</returns>
        public FinancialEvents WithAffordabilityExpenseReversalEventList(AffordabilityExpenseEvent[] affordabilityExpenseReversalEventList)
        {
            this._affordabilityExpenseReversalEventList.AddRange(affordabilityExpenseReversalEventList);
            return this;
        }

        /// <summary>
        /// Checks if AffordabilityExpenseReversalEventList property is set.
        /// </summary>
        /// <returns>true if AffordabilityExpenseReversalEventList property is set.</returns>
        public bool IsSetAffordabilityExpenseReversalEventList()
        {
            return this.AffordabilityExpenseReversalEventList.Count > 0;
        }
        ...
        public override void ReadFragmentFrom(IMwsReader reader)
        {
            ...
            _networkComminglingTransactionEventList = reader.ReadList<NetworkComminglingTransactionEvent>("NetworkComminglingTransactionEventList", "NetworkComminglingTransactionEvent");
            _affordabilityExpenseEventList = reader.ReadList<AffordabilityExpenseEvent>("AffordabilityExpenseEventList", "AffordabilityExpenseEvent");
            _affordabilityExpenseReversalEventList = reader.ReadList<AffordabilityExpenseEvent>("AffordabilityExpenseReversalEventList", "AffordabilityExpenseEvent");
        }
        ...
        public override void WriteFragmentTo(IMwsWriter writer)
        {
            ...
            writer.WriteList("NetworkComminglingTransactionEventList", "NetworkComminglingTransactionEvent", _networkComminglingTransactionEventList);
            writer.WriteList("AffordabilityExpenseEventList", "AffordabilityExpenseEvent", _affordabilityExpenseEventList);
            writer.WriteList("AffordabilityExpenseReversalEventList", "AffordabilityExpenseEvent", _affordabilityExpenseReversalEventList);
        }
