...
namespace MWSFinancesService.Model
{
    public class RentalTransactionEvent : AbstractMwsObject
    {
        ...
        private List<TaxWithheldComponent> _rentalTaxWithheldList;
        ...
        /// <summary>
        /// Gets and sets the RentalTaxWithheldList property.
        /// </summary>
        public List<TaxWithheldComponent> RentalTaxWithheldList
        {
            get
            {
                if(this._rentalTaxWithheldList == null)
                {
                    this._rentalTaxWithheldList = new List<TaxWithheldComponent>();
                }
                return this._rentalTaxWithheldList;
            }
            set { this._rentalTaxWithheldList = value; }
        }

        /// <summary>
        /// Sets the RentalTaxWithheldList property.
        /// </summary>
        /// <param name="rentalTaxWithheldList">RentalTaxWithheldList property.</param>
        /// <returns>this instance.</returns>
        public RentalTransactionEvent WithRentalTaxWithheldList(TaxWithheldComponent[] rentalTaxWithheldList)
        {
            this._rentalTaxWithheldList.AddRange(rentalTaxWithheldList);
            return this;
        }

        /// <summary>
        /// Checks if RentalTaxWithheldList property is set.
        /// </summary>
        /// <returns>true if RentalTaxWithheldList property is set.</returns>
        public bool IsSetRentalTaxWithheldList()
        {
            return this.RentalTaxWithheldList.Count > 0;
        }
        ...
        public override void ReadFragmentFrom(IMwsReader reader)
        {
            ...
            _rentalTaxWithheldList = reader.ReadList<TaxWithheldComponent>("RentalTaxWithheldList", "TaxWithheldComponent");
        }
        ...
        public override void WriteFragmentTo(IMwsWriter writer)
        {
            ...
            writer.WriteList("RentalTaxWithheldList", "TaxWithheldComponent", _rentalTaxWithheldList);
        }
