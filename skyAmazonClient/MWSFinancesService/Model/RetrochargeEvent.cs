...
namespace MWSFinancesService.Model
{
    public class RetrochargeEvent : AbstractMwsObject
    {
        ...
        private List<TaxWithheldComponent> _retrochargeTaxWithheldList;
        ...
        /// <summary>
        /// Gets and sets the RetrochargeTaxWithheldList property.
        /// </summary>
        public List<TaxWithheldComponent> RetrochargeTaxWithheldList
        {
            get
            {
                if(this._retrochargeTaxWithheldList == null)
                {
                    this._retrochargeTaxWithheldList = new List<TaxWithheldComponent>();
                }
                return this._retrochargeTaxWithheldList;
            }
            set { this._retrochargeTaxWithheldList = value; }
        }

        /// <summary>
        /// Sets the RetrochargeTaxWithheldList property.
        /// </summary>
        /// <param name="retrochargeTaxWithheldList">RetrochargeTaxWithheldList property.</param>
        /// <returns>this instance.</returns>
        public RetrochargeEvent WithRetrochargeTaxWithheldList(TaxWithheldComponent[] retrochargeTaxWithheldList)
        {
            this._retrochargeTaxWithheldList.AddRange(retrochargeTaxWithheldList);
            return this;
        }

        /// <summary>
        /// Checks if RetrochargeTaxWithheldList property is set.
        /// </summary>
        /// <returns>true if RetrochargeTaxWithheldList property is set.</returns>
        public bool IsSetRetrochargeTaxWithheldList()
        {
            return this.RetrochargeTaxWithheldList.Count > 0;
        }
        ...
        public override void ReadFragmentFrom(IMwsReader reader)
        {
            ...
            _retrochargeTaxWithheldList = reader.ReadList<TaxWithheldComponent>("RetrochargeTaxWithheldList", "TaxWithheldComponent");
        }
        ...
        public override void WriteFragmentTo(IMwsWriter writer)
        {
            ...
            writer.WriteList("RetrochargeTaxWithheldList", "TaxWithheldComponent", _retrochargeTaxWithheldList);
        }
